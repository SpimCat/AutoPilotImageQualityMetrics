...
@Plugin(type = Command.class, menuPath = "Plugins>SpimCat>Quality measurement>Image Focus Measurements of a region slice by slice (Adapted Autopilot code, Royer et Al. 2016)")
